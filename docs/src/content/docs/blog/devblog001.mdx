...
Generic Incremental Interactive eNgine (GIIN) is a small game engine for building menu-driven games. It currently supports basic visual novel mechanics similar to [Twine](www.twinery.org), and is in development towards supporting incremental and adventure game mechanics. It is built on ReactJS and is in early development. Its primary data-editing interface is MS Excel.
