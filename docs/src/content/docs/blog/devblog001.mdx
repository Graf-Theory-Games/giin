...
Fortunately, xlwings was already available by the time I felt I was ready to make my own exporter.
...
- My next goal, feature-wise, is to create a player character. I don't have a player character object yet, so the player character doesn't have a score, or energy, or any other stat.
- I have to refactor the game screen, written all in React, as I feel my first pass was a little janky.
- I have to study more about React Hooks because at the moment I use several of them without fully understanding them.
