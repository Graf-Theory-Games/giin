...
Now that we have defined scale levels ("Best", "Terrible", "Good" and so on), we've defined only a certain subset of numbers.
...
You'll notice that **Good** didn't appear. One of the side effects of normalization is the ease by which variety or a lack thereof can be easier to see.
