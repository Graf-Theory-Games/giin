...
The environment of a game is largely controlled by invisible sliders, dials, and levers. How do we game designers know to what setting these controls should be? By identifying **core factors**, we're able to set a goal or ideal towards which we can set initial values and then playtest and tweak for.
...
## Establishing the size of a game loop
