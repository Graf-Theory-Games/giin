...
_[tk should have an image]_

The environment of a game is largely controlled by invisible sliders, dials, and levers. How do we game designers know what values to set? By identifying some anchors or constraints, we're able to set a goal or ideal towards which we can set initial values and then playtest and tweak for.

## Establishing the size of a game

Outside of games, how does one decide on the size of a project? Say a home improvement project, such as building a small climbing wall. What factors decide how big can be? Safety, surely, and also the hard constraint of your floor size. Once you've found a place for it, you'll have to figure out how many panels and studs and holds you'll need. As with anything else, you are faced with the ancient need to balance a book.

### Working backwards with a budget 
