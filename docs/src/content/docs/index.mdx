...
**No GenAI or LLM tools** are used to create any content or code for this project. Nor are GenAI or LLM tools in **any** part of the development pipeline, **not even for placeholders**.
