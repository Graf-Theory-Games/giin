...
GIIN makes use of MS Excel to create data or content in games. This enables you to easily create stats for your player characters, creatures, and more in a tabular and intuitive environment.
...
- The Sleipnir game engine, which was used for a variety of [Adventure games](https://hogs.fandom.com/wiki/Boomzap_Entertainment). It supported hidden object ane various puzzle mechanics.

## Credits

- GIIN was created and is actively developed by @urbanpidgeon.
- GIIN logo asset designed by Rochak Shukla on freepik.com.

### No-GenAI, no-LLM philosophy

**No GenAI or LLM tools** are used to create any content or code for this project. A human being wrote what you are reading now and a human being wrote, writes, and will write all the content in this manual.
